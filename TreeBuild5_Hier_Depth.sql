...
/* Combine parent child with depth recurssion */

select a.MGR_Name, a.EMP_Name, b.depth
from #depthID as a
inner join #depthChart as b on a.EMP_Name = b.EMP_Name
order by MGR_Name, depth;
